...
begin
	...
	puts "  * provisioning_profile: #{provisioning_profile}"
	...
	raise 'provisioning_profile is not set' unless not provisioning_profile.to_s.eql?('')
	...
	resigner.resign(distribution_type, ipa_path, provisioning_profile, team_id, app_id_prefix)
rescue => ex
